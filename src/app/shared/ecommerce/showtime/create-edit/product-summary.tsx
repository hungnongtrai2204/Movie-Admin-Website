...
import { API_CINEMA_SYSTEM, API_MOVIE } from '@/API';
...
export default function ProductSummary({ className }: { className?: string }) {
  ...
  return (
    <FormGroup
      title="Sơ lược"
      description="Chỉnh sửa mô tả lịch chiếu phim của bạn và thông tin cần thiết từ đây"
      className={cn(className)}
    >
      {/* <Input
        label="Tên"
        placeholder="Tên lịch chiếu phim"
        {...register('title')}
