...
export const getColumns = ({
  ...
  {
    title: <HeaderCell title="Mã" />,
    dataIndex: 'id',
    key: 'id',
    width: 120,
    render: (value: string) => <Text>{value.slice(0, 4)}...</Text>,
  },
  {
    title: <HeaderCell title="Khách Hàng" />,
    dataIndex: 'customer',
    key: 'customer',
    width: 300,
  ...
  // },
  {
    title: <HeaderCell title="Cụm Rạp" />,
    dataIndex: 'theatercomplex',
    key: 'theatercomplex',
    width: 250,
    render: (value: string) => <Text>{value}</Text>,
  },
  {
    title: <HeaderCell title="Rạp" />,
    dataIndex: 'theater',
    key: 'theater',
    width: 120,
    render: (value: string) => <Text>{value}</Text>,
