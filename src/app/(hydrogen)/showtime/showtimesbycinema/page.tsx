...
import ShowtimeByCinemaTable from '@/app/shared/invoice/invoice-list/showtimebycinema-table';
...
const pageHeader = {
  title: 'Danh Sách Lịch Chiếu Theo Hệ Thống Rạp',
  breadcrumb: [
    {
...
export default function ProductsPage() {
  ...
  return (
    <>
      ...
      {movies.length > 0 && <ShowtimeByCinemaTable data={invoiceData} />}
    </>
  );
}
