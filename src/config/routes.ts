export const routes = {
  ...
  movie: {
    dashboard: '/movie',
    movies: '/movie/movies',
    createMovie: '/movie/movies/create',
    editMovie: (slug: string) => `/movie/movies/${slug}/edit`,
  },
  cinemaSystem: {
    dashboard: '/cinemasystem',
    cinemasystems: '/cinemasystem/cinemasystems',
    createCinemaSystem: '/cinemasystem/cinemasystems/create',
    editCinemaSystem: (slug: string) =>
      `/cinemasystem/cinemasystems/${slug}/edit`,
  },
  theaterComplex: {
    dashboard: '/theatercomplex',
    theaterComplexes: '/theatercomplex/theatercomplexes',
    createTheaterComplex: '/theatercomplex/theatercomplexes/create',
    editTheaterComplex: (slug: string) =>
      `/theatercomplex/theatercomplexes/${slug}/edit`,
  },
  theater: {
    dashboard: '/theater',
    theaters: '/theater/theaters',
    createTheater: '/theater/theaters/create',
    editTheater: (slug: string) => `/theater/theaters/${slug}/edit`,
  },
  seat: {
    dashboard: '/seat',
    seats: '/seat/seats',
    createSeat: '/seat/seats/create',
    editSeat: (slug: string) => `/seat/seats/${slug}/edit`,
  },
  showtime: {
    dashboard: '/showtime',
    showtimes: '/showtime/showtimes',
    showtimesByCinema: '/showtime/showtimesbycinema',
    createShowtime: '/showtime/showtimes/create',
    editShowtime: (slug: string) => `/showtime/showtimes/${slug}/edit`,
  },
  order: {
    dashboard: '/order',
    orders: '/order/orders',
    createOrder: '/order/orders/create',
    editOrder: (slug: string) => `/order/orders/${slug}/edit`,
  },
  searchAndFilter: {
