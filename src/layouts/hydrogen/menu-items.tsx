...
export const menuItems = [
  ...
  },
  {
    ...
    dropdownItems: [
      ...
      {
        name: 'Thêm Cụm Rạp',
        href: routes.theaterComplex.createTheaterComplex,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    dropdownItems: [
      {
        name: 'Danh Sách Ghế',
        href: routes.seat.seats,
        badge: '',
      },
      {
        name: 'Thêm Ghế',
        href: routes.seat.createSeat,
      },
    ],
  },
  {
    ...
    dropdownItems: [
      {
        name: 'Lịch Chiếu Theo Phim',
        href: routes.showtime.showtimes,
        badge: '',
      },
      {
        name: 'Lịch Chiếu Theo Hệ Thống Rạp',
        href: routes.showtime.showtimesByCinema,
        badge: '',
      },
      {
